...
use crate::MoreThanHalfCouncil;
use crate::Currencies;
use crate::UnknownTokens;
use crate::CollatorSelectionUpdateOrigin;
use frame_support::PalletId;
use xcm_builder::AllowKnownQueryResponses;
use xcm_builder::AllowSubscriptionsFrom;
...
/// Type for specifying how a `MultiLocation` can be converted into an `AcfcountId`. This is used
...
impl Config for XcmConfig {
	...
	type IsReserve = TrustedReservers;
